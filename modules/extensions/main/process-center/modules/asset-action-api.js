...
/***
     ...
     * @returns {{}}
     */
    api.permissions.list = function (am, assetId) {
     ...
     * @returns {boolean}
     */
    api.permissions.add = function (am, pathToAuthorize,
     ...
     * @returns {boolean}
     */
    api.permissions.modify = function (am, resourcePath, permissionString, permissionCheck) {
        var userRegistry = am.registry;
        var registry = userRegistry.registry;
