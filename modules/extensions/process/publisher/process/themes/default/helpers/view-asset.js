...
var resources = function () {
    return {
        js: ['flowchart/jsPlumb-2.0.7.js', 'libs/jquery.form.min.js', 'publisher-utils.js', 'view-asset.js', 'jquery-ui.js',
            ...
            'jquery-file-upload/vendor/jquery.ui.widget.js', 'bootstrap-editable.js','view-asset-functions.js', 'flowchart/view-flowchart.js', 'FileSaver.min.js',
            'advance-search.js', 'jquery.form.js', 'flowchart/base64.js','flowchart/canvas2image.js', 'flowchart/canvg.js',
            'flowchart/html2canvas.js'],
        css: ['flowchart/jsPlumb-defaults.css', 'flowchart/jsPlumb-demo.css', 'bootstrap-select.min.css',
            ...
            'bootstrap-editable.css','add-process.css', 'custom.css']
    }
};
