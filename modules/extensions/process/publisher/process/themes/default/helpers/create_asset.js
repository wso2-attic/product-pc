...
var resources = function (page, meta) {
    return {
        js:['flowchart/jquery.jsPlumb-1.4.1-all-min.js','libs/jquery.form.min.js','publisher-utils.js','create_asset.js','jquery-ui.js',
            ...
            "tinymce/tinymce.min.js",'tags/tags-init-create-asset.js','notify.min.js','messages.js','flowchart/base64.js',
            'flowchart/canvas2image.js','flowchart/canvg.js','flowchart/html2canvas.js',
            'jquery-file-upload/jquery.iframe-transport.js','jquery-file-upload/jquery.fileupload.js',
            'jquery-file-upload/vendor/jquery.ui.widget.js','create-asset-functions.js','flowchart/app.js'],
        css:['flowchart/jsPlumbToolkit-defaults.css','flowchart/jsPlumbToolkit-demo.css','bootstrap-select.min.css',
