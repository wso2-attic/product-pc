...
$(function () {
    ...
    var wireLCActionHandlers = function (container) {
        $(id(container)).children('a').each(function () {
            $(this).on('click', function (e) {
                ...
                changeLCStateListener(action, comment);
            });
        });
    };

    var changeLCStateListener = function (action, comment) {

        var question = "Are you sure you want to change the lifecycle state?";
    ...
    var confirmDialog = function (question) {
        var confirmModal =
            $('<div class="modal fade">' +
                ...
                '<h3>Confirm lifecycle state change</h3>' +
                '</div>' +
                ...
                '<a href="#!" id="okButton" class="btn btn-primary">Change</a>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>');
