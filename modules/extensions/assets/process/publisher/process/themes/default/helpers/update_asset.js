...
var resources = function (page, meta) {
    return {
        js: ['flowchart/jsPlumb-2.0.7.js', 'libs/jquery.form.min.js', 'publisher-utils.js', 'jquery-ui.js',
            'jquery-file-upload/alertify.js', 'jquery-file-upload/bootstrap-filestyle.js', 'jquery.cookie.js', 'common/option_text.js',
            "tinymce/tinymce.min.js", 'notify.min.js', 'messages.js',
            'jquery-file-upload/jquery.iframe-transport.js', 'jquery-file-upload/jquery.fileupload.js',
            'jquery-file-upload/vendor/jquery.ui.widget.js', 'create-asset-functions.js', 'update-asset-functions.js', 'bootstrap-editable.js', 'flowchart/view-flowchart.js', 'FileSaver.min.js',
            'advance-search.js', 'jquery.form.js', 'flowchart/base64.js', 'flowchart/canvas2image.js', 'flowchart/canvg.js',
            'flowchart/html2canvas.js', 'auto-complete-tags/bootstrap-tokenfield.min.js', 'audit-log-functions.js','create_asset.js', 'process-association-common.js'],
        css: ['flowchart/jsPlumb-defaults.css', 'flowchart/jsPlumb-demo.css', 'bootstrap-select.min.css',
            ...
            'auto-complete-tags/bootstrap-tokenfield.min.css','add-process.css','process-center-custom.css'],
