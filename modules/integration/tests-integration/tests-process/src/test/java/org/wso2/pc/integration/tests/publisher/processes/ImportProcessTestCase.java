...
public class ImportProcessTestCase extends PCIntegrationBaseTest {
    ...
    public void init() throws Exception {
        ...
        resourcePath =
                FrameworkPathUtil.getSystemResourceLocation() + "artifacts" + File.separator + "json" + File.separator
                        + "process" + File.separator + "create-process.json";
    ...
    private Element getAssociateProcess(String processType) throws Exception {
        ...
        String xml = new String(wsRegistryServiceClient.
                getContent(File.separator + "_system" + File.separator + "governance" + File.separator + "bpmn"
                        + File.separator + "Process1" + File.separator + "1.0"));
    ...
    public void deleteFlowchart() throws JSONException {
        ...
        queryMap.put("flowchartPath",
                String.format("%s%s/%s", PCIntegrationConstants.REG_FLOWCHART_PATH, PROCESS_NAME, PROCESS_VERSION));
        ClientResponse response = genericRestClient
                .geneticRestRequestGet(publisherProcessAPIBaseUrl + "delete_flowchart", queryMap, headerMap,
                        cookieHeader);
