...
public class AnalyticsUtils {
    ...
    public static String getAuthorizationHeader() {
        String userName = getInstance().getProcessCenter().getProcessCenterConfiguration().getAnalyticsServerUsername();
        String password = getInstance().getProcessCenter().getProcessCenterConfiguration().getAnalyticsServerPassword();
        if (userName != null && password != null) {
            return AnalyticsConstants.AUTH_BASIC_HEADER + " " + DatatypeConverter.printBase64Binary(
