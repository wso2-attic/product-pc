...
//                String barContent = "<metadata xmlns=\"http://www.wso2.org/governance/metadata\"><overview><name>b4444</name><version>1.0.0</version><description>hfrefgygeofyure</description></overview><content><contentPath>bpmn_archives_binary/b4444/1.0.0</contentPath></content><bpmn><Name>test_name</Name><Path>bpmn/b4444.TestProcess1.bpmn/1.0.0</Path><Id>815fe296-9363-4895-b386-23162b78bec4</Id></bpmn></metadata>";
    ...
    public org.wso2.carbon.processCenter.core.models.Process[] getProcessByName(String name){
        org.wso2.carbon.processCenter.core.models.Process processes[] = new org.wso2.carbon.processCenter.core.models.Process[2];
        try {
            RegistryService registryService = ProcessCenterServerHolder.getInstance().getRegistryService();
            ...
            if (registryService != null) {
                ...
                for (int i = 0; i < processPaths.length; i++) {
                    ...
                    org.wso2.carbon.processCenter.core.models.Process process = new org.wso2.carbon.processCenter.core.models.Process(words[2], words[3]);
                    processes[i] = process;
